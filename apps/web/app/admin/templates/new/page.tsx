    ...
    <div className="p-6 max-w-xl">
      ...
      <form action={createTemplateFromUpload} className="space-y-4" encType="multipart/form-data">
        <div>
          ...
          <input name="title" type="text" className="w-full rounded border px-3 py-2" required />
        </div>
        <div>
          <label className="block text-sm font-medium mb-1">Image (PNG)</label>
          <input name="file" type="file" accept="image/png,image/*" className="w-full" required />
        </div>
        ...
        <div>
          ...
          <select name="required_entitlement" className="w-full rounded border px-3 py-2 bg-white" defaultValue="">
        ...
        <div>
          ...
          <input name="tags" type="text" className="w-full rounded border px-3 py-2" placeholder="animals, cute, easy" />
        </div>
        <div className="flex gap-3">
          <button type="submit" className="inline-flex items-center rounded-md bg-blue-600 px-4 py-2 text-white hover:bg-blue-700">
            Create
          </button>
          <a href="/admin/templates" className="inline-flex items-center rounded-md border px-4 py-2 hover:bg-gray-50">
            Cancel
          </a>
        </div>
      </form>
